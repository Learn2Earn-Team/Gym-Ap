...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'programs',
                loadChildren: () => __webpack_require__.e(/*! import() | programs-programs-module */ "programs-programs-module").then(__webpack_require__.bind(null, /*! ../programs/programs.module */ "./src/app/pages/programs/programs.module.ts")).then(m => m.ProgramsPageModule)
            },
            {
                path: 'search',
            ...
            {
                path: 'trainers',
                loadChildren: () => __webpack_require__.e(/*! import() | trainers-trainers-module */ "trainers-trainers-module").then(__webpack_require__.bind(null, /*! ../trainers/trainers.module */ "./src/app/pages/trainers/trainers.module.ts")).then(m => m.TrainersPageModule)
            },
            {
                path: 'profile',
            ...
            {
                path: 'articles',
                loadChildren: () => __webpack_require__.e(/*! import() | articles-articles-module */ "articles-articles-module").then(__webpack_require__.bind(null, /*! ../articles/articles.module */ "./src/app/pages/articles/articles.module.ts")).then(m => m.ArticlesPageModule)
            },
            {
                path: 'article-detail',
                loadChildren: () => __webpack_require__.e(/*! import() | article-detail-article-detail-module */ "article-detail-article-detail-module").then(__webpack_require__.bind(null, /*! ../article-detail/article-detail.module */ "./src/app/pages/article-detail/article-detail.module.ts")).then(m => m.ArticleDetailPageModule)
            },
            {
                path: 'settings',
                loadChildren: () => __webpack_require__.e(/*! import() | settings-settings-module */ "settings-settings-module").then(__webpack_require__.bind(null, /*! ../settings/settings.module */ "./src/app/pages/settings/settings.module.ts")).then(m => m.SettingsPageModule)
            },
            {
                path: 'trainer-profile',
                loadChildren: () => __webpack_require__.e(/*! import() | trainer-profile-trainer-profile-module */ "trainer-profile-trainer-profile-module").then(__webpack_require__.bind(null, /*! ../trainer-profile/trainer-profile.module */ "./src/app/pages/trainer-profile/trainer-profile.module.ts")).then(m => m.TrainerProfilePageModule)
            },
            {
                path: 'edit-profile',
                loadChildren: () => __webpack_require__.e(/*! import() | edit-profile-edit-profile-module */ "edit-profile-edit-profile-module").then(__webpack_require__.bind(null, /*! ../edit-profile/edit-profile.module */ "./src/app/pages/edit-profile/edit-profile.module.ts")).then(m => m.EditProfilePageModule)
            },
            {
                path: 'reset-password',
                loadChildren: () => __webpack_require__.e(/*! import() | reset-password-reset-password-module */ "reset-password-reset-password-module").then(__webpack_require__.bind(null, /*! ../reset-password/reset-password.module */ "./src/app/pages/reset-password/reset-password.module.ts")).then(m => m.ResetPasswordPageModule)
            },
            {
                path: 'notification',
            ...
            },
            {
                ...
                loadChildren: () => __webpack_require__.e(/*! import() | terms-conditions-terms-conditions-module */ "terms-conditions-terms-conditions-module").then(__webpack_require__.bind(null, /*! ../terms-conditions/terms-conditions.module */ "./src/app/pages/terms-conditions/terms-conditions.module.ts")).then(m => m.TermsConditionsPageModule)
            },
            {
                path: '',
